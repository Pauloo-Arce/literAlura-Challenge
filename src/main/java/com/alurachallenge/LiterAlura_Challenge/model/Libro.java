...
import com.alurachallenge.LiterAlura_Challenge.dto.Genero;
import com.alurachallenge.LiterAlura_Challenge.model.record.DatosLibro;
import com.alurachallenge.LiterAlura_Challenge.model.record.MediaLibro;
...
public class Libro {
    ...
    public Libro(DatosLibro datosLibro) {
        ...
        this.imagen = imagenModificada(new MediaLibro(datosLibro.imagen()));
        this.cantidadDescargas = datosLibro.cantidadDescargas();
    }

    public Libro(com.alurachallenge.LiterAlura_Challenge.record.DatosLibro libro) {
    }
    ...
    private String imagenModificada(MediaLibro media) {
